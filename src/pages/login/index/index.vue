<template>
  <div class="page_container !bg-white px-10 relative">
    <img
      ...
      alt=""
    />
    <div class="text-lg font-semibold mx-auto text-primary">
      {{ $t("welcome") }}
    </div>
            ...
            <div class="mt-5">
              ...
              <div class="border border-gap-text rounded-lg">
                <van-field
                  ...
                  name="userAccount"
                  type="text"
                  :placeholder="$t('placeholder.inputUserAccount')"
                />
              </div>
            </div>
          </van-tab>
          ...
          <van-button
            ...
            :disabled="
              tabActive == 0
                ...
                : !(formData.userAccount && formData.password)
            "
            block
            type="primary"
            native-type="submit"
...
const performLogin = async (loginData : any) => {
  try {
    const {
